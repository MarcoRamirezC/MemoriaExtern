package com.example.marc.memoriaextern;
            ...
            if (Environment.getExternalStorageState().equals("mounted")) {
                ...
                if (v.equals(btnGuardar)) {
                    ...
                    try {
                        ...
                        // directorio
// la memoria externa
                        directory = new File(extSdCard.getAbsolutePath() + "/APK");
...
// bytes
                        ...
                        Toast.makeText(getBaseContext(), "El archivo se almaceno!!!", Toast.LENGTH_SHORT).show();
...
// final
                        ...
                        Toast.makeText(getBaseContext(), "El archivo se ha cargado Correctamente", Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
